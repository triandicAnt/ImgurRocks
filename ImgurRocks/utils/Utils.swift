...
class Utils {
    static let CLIENT_ID:String = "****" // Change it
    static let CLIENT_SECRET:String = "****" // change it
    static let ACCESS_TOKE:String = "****" // also change it
    static let REFRESH_TOKEN:String = "***" // do not miss this one
    static let MY_URL:String = "https://api.imgur.com/3/account/USER_NAME"
